...
public class DepositoController {
    ...
    public DepositoController(ContaService contaService, UsuarioAtual usuarioAtual) {
    ...
    public String submit(@AuthenticationPrincipal UserDetails principal,
        ...
        try {
            contaService.depositar(usuario.id(), valor);
            ra.addFlashAttribute("mensagem", Mensagens.DEPOSITO_REALIZADO);
