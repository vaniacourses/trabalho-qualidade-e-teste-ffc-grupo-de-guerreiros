...
<%
    ...
    String msg = (String) session.getAttribute("msgDeposito");
...
<head>
    ...
    <title>Depósito – Banco Campos</title>
    <style>
        :root {
            --bg: #0b1c2c;
            --accent: #d4af37;
...
<body>
    ...
    <div class="card">
        <h2>Conta <%= conta %></h2>
        <p>Saldo atual: <strong>R$ <%= df.format(saldo) %></strong></p>
        ...
        <% if (msg != null) { %>
            ...
            <% session.removeAttribute("msgDeposito"); %>
        <% } %>
        ...
        <form method="post" action="deposito">
            ...
            <button class="main-btn" type="submit">Depositar</button>
        </form>
